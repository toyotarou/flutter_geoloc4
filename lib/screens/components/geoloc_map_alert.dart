...
class GeolocMapAlert extends StatefulWidget {
  ...
  @override
  State<GeolocMapAlert> createState() => _GeolocMapAlertState();
}

class _GeolocMapAlertState extends State<GeolocMapAlert> {
  @override
